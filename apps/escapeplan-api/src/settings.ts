...
const DEFAULTS: Record<string, string> = {
  ...
  [SETTING_KEYS.BUSINESS.DEFAULT_TEXT_HINT_SOUND_ASSET_ID]: String(BUSINESS_DEFAULTS.DEFAULT_TEXT_HINT_SOUND_ASSET_ID),
  [SETTING_KEYS.BUSINESS.DEFAULT_TEXT_HINT_DURATION_SECONDS]: String(BUSINESS_DEFAULTS.DEFAULT_TEXT_HINT_DURATION_SECONDS),
...
class SettingsManager {
  ...
  getDefaultTextHintSoundAssetId(): string | null {
    const value = this.get(SETTING_KEYS.BUSINESS.DEFAULT_TEXT_HINT_SOUND_ASSET_ID);
