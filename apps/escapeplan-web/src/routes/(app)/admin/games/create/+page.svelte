...
<script lang="ts">
  ...
  interface EditableHint extends GameHintDefinition {
    // All properties now inherited from GameHintDefinition
  }
  ...
  <header class="sticky top-0 z-10 bg-base-100 border-b border-white/10">
    <div class="container mx-auto px-4 py-4">
      <div class="flex items-center justify-between mb-4">
        <div>
          <h1 class="text-2xl font-bold text-base-content">Add Game Configuration</h1>
          <p class="text-sm text-base-content/60">Configure game metadata, media assets, puzzles, pricing, and booking rules.</p>
        </div>
      </div>
