  ...
  <div class="grid gap-6 lg:grid-cols-[2fr_1fr]">
    <section class="space-y-6">
      ...
      <div id="milestones" class="glass-panel border-white/10 bg-base-200/70 p-6">
        ...
        {:else}
          <p class="mt-3 text-sm text-base-content/60">No milestones configured for this game.</p>
        {/if}
      </div>
        ...
        <div class="mt-5 space-y-3">
          {#each session.puzzles as puzzle}
            {#if puzzle.status === 'completed'}
              ...
              <details class="rounded-xl border border-success/40 bg-success/10">
                <summary class="flex cursor-pointer items-center justify-between gap-2 p-4 hover:bg-success/15 transition">
                  <h3 class="font-semibold text-base-content">{puzzle.title}</h3>
                  <span class="badge badge-sm badge-success uppercase tracking-[0.25em]">
                    Completed
                  </span>
                </summary>
                <div class="px-4 pb-4 space-y-3">
                  ...
                  {#if puzzle.description}
                    <p class="text-sm text-base-content/70">{puzzle.description}</p>
                  {/if}
      ...
      <details id="streams" class="glass-panel border-white/10 bg-base-200/70">
        <summary class="flex cursor-pointer items-center justify-between gap-2 p-6 hover:bg-base-200/90 transition">
        ...
        <div class="px-6 pb-6">
          <div class="overflow-hidden rounded-2xl border border-white/10 bg-neutral/10">
