          ...
          <div class="form-control">
            ...
            {#if showAutoplayWarning}
              <div class="alert mb-4 border border-info/30 bg-info/20 text-sm text-info-content">
                ...
                <span>Most modern browsers do not allow autoplay with sound by default. Please whitelist https://console.ofthecouch.io/ in your browser settings in order for audio and video hints to work.</span>
              </div>
            {/if}
